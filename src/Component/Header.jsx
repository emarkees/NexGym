      ...
      <div className="header__basket__nav">
        ...
        <div className="header__nav">
          <div className="burger" onClick={toggleDropdown}>
            <div className={`burger__line ${isDropdownOpen ? "active" : ""}`}></div>
            <div className={`burger__line ${isDropdownOpen ? "active" : ""}`}></div>
            <div className={`burger__line ${isDropdownOpen ? "active" : ""}`}></div>
          </div>
          <div className={`dropdown__menu ${isDropdownOpen ? "show" : ""}`}>
            <ul>
              <li>
                <RouterLink to="/about" className="dropdown__item" onClick={handleLinkClick}>
                  About Us
                </RouterLink>
              </li>
              <li>
                <RouterLink to="/schedule" className="dropdown__item" onClick={handleLinkClick}>
                  Schedule
                </RouterLink>
              </li>
              <li>
                <RouterLink to="/contact" className="dropdown__item" onClick={handleLinkClick}>
                  Contact
                </RouterLink>
              </li>
              <li>
              ...
              <li>
                <RouterLink to="/store" className="dropdown__item" onClick={handleLinkClick}>
                  Store
                </RouterLink>
              </li>
              <li>
